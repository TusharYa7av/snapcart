...
import { addToCart, decreaseQuantity, increaseQuantity } from '@/redux/cardSlice'  // ✅ FIXED PATH
    ...
    >
      ...
      <div className='p-4 flex flex-col flex-1'>
        ...
        {!cartItem ?<motion.button
          whileTap={{ scale: 0.8 }}
          className='mt-4 flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white rounded-full py-2 text-sm font-medium'
          onClick={() =>
            dispatch(
              addToCart({
                ...item,
        ...
        transition={{duration:0.3}}
          className='mt-4 flex items-center justify-center bg-green-50 border-green-200 rounded-full py-2 px-4 gap-4'
        >
