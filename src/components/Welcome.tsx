  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6">
      ...
      >
        ...
        daily essentials delivery right to your doorstep!
      </motion.p>
      ...
      >
        <ShoppingBasket className="w-23 h-24 md:w-32 md:h-32 text-green-700" />
        <Bike className="w-32 h-32 md:h-32 md:w-32 text-orange-400" />
      </motion.div>
