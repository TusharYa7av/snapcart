...
const CatigeorySlider = () => {
  const categories = [
    {id: 1 , name: "Fruites & Vegitables", icon: Apple, color : "bg-green-100"},
    ...
    {id: 8 , name: "Household Essentails", icon: Home, color : "bg-lime-100"},
    {id: 9 , name: "Instant & Packaged", icon: Box, color : "bg-teal-100"},
...
export default CatigeorySlider
