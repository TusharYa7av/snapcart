...
const HeroSection = () => {
  const slides=[
    {
      id:1,
      icon:<Leaf className='w-20 h-20 sm:w-28 text-green-400 drop-shadow-lg'/>,
      title:"Fresh Organic Groceries 🫑",
      subtitle:"Farm-fresh fruits, vegetables , and daily essentials delivery to you.",
      btnText:"Show Now",
    ...
    {
      id:2,
      icon:<Truck className='w-20 h-20 sm:w-28 text-yellow-400 drop-shadow-lg' />,
      title:"Fast & Reliable Delivery 🚚",
      subtitle:"We ensure your groceries reach your doorsteps in no time",
      btnText:"Order Now",
      bg:"https://media.istockphoto.com/id/876053206/photo/grocery-store-delivey-man-delivering-food-to-a-woman-at-home.webp?a=1&b=1&s=612x612&w=0&k=20&c=kbwRGy71ezJKsy40UxVDVi86TmV947fYS0YpE6Fb-lg=",
    },
    {
      id:3,
      icon:<Smartphone className='w-20 h-20 sm:w-28 text-blue-400 drop-shadow-lg'/>,
      title:"Shop Anytime , Anywhere 📱",
      subtitle:"Easy and seamless online grocery shopping experience.",
      btnText:"Get Started",
      bg:"https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8Z3JvY2VyaWVzfGVufDB8fDB8fHww",
    }
  ]
