...
const AddGrocery = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-liner-to-br from-green-50 to-white py-16 px-4 relative'>
    ...
    >
      ...
      <form className='flex flex-col gap-6 w-full' onSubmit={handleSubmit}>
        <div>
          ...
          <input type="text" id='name' placeholder='eg: veges,fruits...' onChange={(e)=>setName(e.target.value)} value={name} className='w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all' />
        </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
          ...
          <select name="unit" className='w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all bg-white' onChange={(e: React.ChangeEvent<HTMLSelectElement>)=>setUnit(e.target.value)} value={unit}>
        ...
        <div>
          ...
          <input type="text" id='name' placeholder='eg:120' className='w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all'onChange={(e)=>setPrice(e.target.value)} value={price}/>
        </div>

        <div className='flex flex-col sm:flex-row items-center gap-5'>
          <label htmlFor="image" className='cursor-pointer flex items-center justify-center gap-2 bg-green-50 text-green-700 font-semibold border border-green-200 rounded-xl px-6 py-3 hover:bg-green-100 transition-all w-full sm:w-auto'><Upload className='h-5 w-5' />Upload Image </label>
