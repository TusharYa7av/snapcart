  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
      ...
      <motion.h1
        ...
        <p className='text-gray-600 mb-8 flex items-center gap-1'>Login to SnapCart <Leaf className='w-5 h-5 text-green-600'/></p>
        ...
        className='flex flex-col gap-5 w-full max-w-sm'>
           ...
           <div className='relative'>
            ...
            <input type="email" placeholder=' your email' className='w-full border border-gray-300 rounded-xl py-3 pl-10 pr-4 text-gray-800 focus:ring-2 focus:ring-green-500 focus:outline-none' 
        ...
        <p className='text-gray-600 mt-6 text-sm flex items-center gap-1 cursor-pointer' onClick={()=>router.push("/register")}>Want to create an Account ? <LogIn className=''/><span className='text-green-600'>Sign up</span></p>
